...
with st.sidebar:
    ...
    if ('EMAIL' in st.secrets) and ('PASS' in st.secrets):
        ...
        st.markdown('🤗 Dont have an account? [Sign Up](https://huggingface.co/join/)!')
    ...
    st.markdown('📖 Learn to build this app from dataprofessor [blog](https://blog.streamlit.io/how-to-build-an-llm-powered-chatbot-with-streamlit/)!')   
    st.sidebar.write("""
         ######
